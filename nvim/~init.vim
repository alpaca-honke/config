...
" lexima
" なんか動かない
"call lexima#add_rule({'char': '<CR>', 'at': '\>\%#\<', 'input': '<TAB>', 'input_after': '<CR>', 'filetype': 'html'})

" for fern
nnoremap <silent> <C-n> :Fern . -reveal=% -drawer -toggle -width=35<CR>
" nvim terminal mode
tnoremap <Esc> <C-\><C-n>
tnoremap jj <C-\><C-n>
...
"hi DiffText 
hi CocInlayHint ctermfg=7 ctermbg=242
